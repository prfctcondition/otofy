...
import { X, HelpCircle, Play, Pause, Check, Clock, AlertTriangle, Music } from 'lucide-react';
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-md animate-in fade-in duration-200">
      <div className="bg-white/95 dark:bg-[#0C0C10] backdrop-blur-3xl border border-white/80 dark:border-white/10 rounded-3xl w-full max-w-xl flex flex-col p-6 m-4 relative shadow-[0_25px_60px_rgba(0,0,0,0.35)]">
        ...
        {/* Original Target Track Banner */}
        <div className="p-3.5 rounded-2xl bg-amber-50/80 dark:bg-amber-950/20 border border-amber-200/80 dark:border-amber-900/40 mb-4 flex items-center justify-between">
        ...
        <div className="space-y-2 mb-5">
          <div className="text-xs font-bold text-[#64748B] dark:text-white/60 uppercase tracking-wider px-1">
        ...
        {/* Footer info */}
        <div className="flex items-center justify-between text-[11px] text-[#64748B] dark:text-white/60 pt-3 border-t border-slate-200/80 dark:border-white/10">
